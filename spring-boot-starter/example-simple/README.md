...
5. When implementing the process application in [standard manner](https://docs.camunda.org/manual/7.22/user-guide/process-applications/the-process-application-class/),
