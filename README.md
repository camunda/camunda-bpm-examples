...
| [Service Task SOAP HTTP](/servicetask/soap-service) (2)                    | Unit Test            | SOAP Scripting, classless |
| [Service Task SOAP CXF HTTP](/servicetask/soap-cxf-service) (2)            | Unit Test            | SOAP, CXF, Spring, Spin   |
...
| [User Task Form Embedded](/usertask/task-form-embedded) (1)                | All                  | Html, Form, Usertask      |
...
| [User Task Form Embedded - JSON](/usertask/task-form-embedded-json-variables) (1)                              | All    | Html, Form, Usertask |
| [User Task Form Embedded - Bpmn Elements](/usertask/task-form-embedded-bpmn-events) (1)| All      | Html, Form, Usertask      |
| [User Task Form Embedded - React](/usertask/task-form-embedded-react) (1)  | All                  | Html, Form, Usertask      |
| [User Task Form - Camunda Forms](/usertask/task-camunda-forms) (1)         | All                  | Html, Form, Usertask      |
...
(1) _Complete demo applications_. \
(2) _This example is not actively maintained anymore._
