...
[Camunda DMN engine]: https://docs.camunda.org/manual/7.24/user-guide/dmn-engine/
[Reference Guide]: https://docs.camunda.org/manual/7.24/reference/dmn/drg/
[User Guide]: https://docs.camunda.org/manual/7.24/user-guide/dmn-engine/testing/
