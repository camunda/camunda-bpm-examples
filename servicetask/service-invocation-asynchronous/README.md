...
> *Note:* this example demonstrates an advanced usage pattern of the process engine. The same behavior can also be achieved using a send task and a receive task.
