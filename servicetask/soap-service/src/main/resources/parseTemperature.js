...
const rawForecast = execution.getVariable('forecast');
const forecast = rawForecast.substring(rawForecast.indexOf("\n"));

const parsedTemperature = S(forecast).childElement("Temperature").textContent();
