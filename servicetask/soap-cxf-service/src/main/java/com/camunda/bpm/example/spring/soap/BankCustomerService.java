...
public class BankCustomerService {
  ...
  protected static final Logger LOG = Logger.getLogger(BankCustomerService.class.getName());

  protected BankCustomerClientService service;
  ...
  protected BankRequestHeader getSecurityHeader(DelegateExecution execution) {
