...
This example attempts to illustrate the way to implement (or use) the [JS SDK](https://github.com/camunda/camunda-bpm-platform/tree/7.17/webapps/camunda-bpm-sdk-js) to work with user task forms.
