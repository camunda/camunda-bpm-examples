...
4. Deploy it to a shared process engine distribution of your own choice (Tomcat, Wildfly up to version 26, Weblogic, Websphere - this example does not work with Camunda Platform Run)
