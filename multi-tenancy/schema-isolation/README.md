...
See the [user guide](https://docs.camunda.org/manual/7.24/user-guide/process-engine/multi-tenancy/) for a general introduction on multi-tenancy and the different options Camunda offers.
...
Execute the create scripts (`h2_engine_7.24.0.sql` and `h2_identity_7.24.0.sql`) after selecting the appropriate schema for the current connection:

```sql
set schema TENANT1;

<<paste sql/create/h2_engine_7.24.0.sql here>>
<<paste sql/create/h2_identity_7.24.0.sql here>>
