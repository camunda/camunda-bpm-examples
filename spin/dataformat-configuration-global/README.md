...
You can find the Spin documentation on configuring data formats [here](https://docs.camunda.org/manual/7.19/reference/spin/extending-spin/#configuring-data-formats).
